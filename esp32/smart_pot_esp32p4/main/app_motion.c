...
static esp_err_t init_mpu6050(motion_ctx_t *ctx)
{
    ...
    ctx->last_accel_mag = sqrtf(baseline.accel_x_g * baseline.accel_x_g +
                                baseline.accel_y_g * baseline.accel_y_g +
                                baseline.accel_z_g * baseline.accel_z_g);
